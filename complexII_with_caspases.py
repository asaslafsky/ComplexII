...
#i=inactive, a=active
Monomer('Caspases', ['casp', 'mod'], {'mod': ['i', 'a']})
...
Initial(Caspases(casp=None, mod='i'), Caspases_0)
...
Observable('obsCaspases', Caspases(casp=None, mod='a'))
...
for tnf_title, dose in TNF_LOOP:
    ...
    # for obs, y1, y2 in obs_y_range:
        ...
        ssa_name = path + 'Casp_%d_SSA_%s.png' % (dose, obs)
    ...
    # col = ['obsComplexI', 'obsComplexIIa', 'obsComplexIIb', 'obsMLKLp', 'obstBID', 'obsCaspases']
    ...
    #         pdf_name = path + 'Casp_%d_KDE_%dhrs_%s.png' % (dose, t_point / 60, obs.name)
